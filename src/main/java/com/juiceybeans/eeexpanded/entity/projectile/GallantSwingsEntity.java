...
public class GallantSwingsEntity extends AbstractArrow implements ItemSupplier {
    ...
    public GallantSwingsEntity(EntityType<? extends AbstractArrow> entityType, double x, double y, double z, Level level) {
    ...
    public static GallantSwingsEntity shoot(Level level, LivingEntity shooter, float power, double damage, int knockback) {
