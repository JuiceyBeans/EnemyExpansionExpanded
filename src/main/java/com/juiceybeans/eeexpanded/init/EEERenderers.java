...
public class EEERenderers {
    ...
    private static final Map<DeferredObject<EntityType<? extends Entity>>, EntityRendererProvider<?>> providers = Maps
            .newHashMap();
    ...
    public static void registerRenderers() {
        ...
        registerEntityRender(EEEntities.PROPELLER, PropellerRenderer::new);
    }
    ...
    private static <T extends Entity> void registerEntityRender(DeferredObject<EntityType<T>> entityType,
